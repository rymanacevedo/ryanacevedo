...
- **UI/UX Design and Optimization**:
    - Designed and implemented responsive user interfaces using the Chakra UI design system, improving consistency and accelerating feature delivery.
    - Built drag-and-drop interfaces with React Beautiful DnD to make key workflows more efficient and intuitive.
...
- **State Management and Bug Reduction**:
    - Utilized Context API and Jotai to make frontend state more predictable and maintainable.
